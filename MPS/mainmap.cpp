...

{
    ...
    graph.nodes[25]->setname("Side Dentisry"); graph.nodes[25]->setcoordinates(ui->SideS->pos().x(),ui->SideS->pos().y()); graph.nodes[25]->buttons(ui->SideS);
...
void MainMap:: on_Main_clicked(){
    graph.setstart(graph.nodes[0]);
    showStart();
}
void MainMap::on_sideMain_clicked(){
    graph.setstart(graph.nodes[1]);
    showStart();
}
void MainMap:: on_Gyro_clicked(){
    graph.setstart(graph.nodes[79]);
    showStart();
}
void MainMap:: on_Sbarro_clicked(){
    graph.setstart(graph.nodes[80]);
    showStart();
}
void MainMap:: on_TBS_clicked(){
    graph.setstart(graph.nodes[2]);
    showStart();
}
void MainMap:: on_BasketBallCourt_clicked(){
    graph.setstart(graph.nodes[3]);
    showStart();
}
void MainMap:: on_BatatesandZalabya_clicked(){
    graph.setstart(graph.nodes[4]);
    showStart();
}
void MainMap:: on_Booth_clicked(){
    graph.setstart(graph.nodes[5]);
    showStart();
}
void MainMap:: on_Cinnabon_clicked(){
    graph.setstart(graph.nodes[6]);
    showStart();
}
void MainMap:: on_Clinic_clicked(){
    graph.setstart(graph.nodes[7]);
    showStart();
}
void MainMap:: on_CoffeeBoy_clicked(){
    graph.setstart(graph.nodes[8]);
    showStart();
}
void MainMap:: on_Entry_clicked(){
    graph.setstart(graph.nodes[9]);
    showStart();
}
void MainMap:: on_Exit_clicked(){
    graph.setstart(graph.nodes[10]);
    showStart();
}
void MainMap:: on_Faraghly_clicked(){
    graph.setstart(graph.nodes[11]);
    showStart();
}
void MainMap:: on_FootballField_clicked(){
    graph.setstart(graph.nodes[12]);
    showStart();
}
void MainMap:: on_K__clicked(){
    graph.setstart(graph.nodes[13]);
    showStart();
}
void MainMap:: on_LaFraise_clicked(){
    graph.setstart(graph.nodes[14]);
    showStart();
}
void MainMap:: on_Manousha_clicked(){
    graph.setstart(graph.nodes[15]);
    showStart();
}
void MainMap:: on_MiniMarket_clicked(){
    graph.setstart(graph.nodes[16]);
    showStart();
}
void MainMap:: on_Mosque_clicked(){
    graph.setstart(graph.nodes[17]);
    showStart();
}
void MainMap:: on_N__clicked(){
    graph.setstart(graph.nodes[18]);
    showStart();
}
void MainMap:: on_OpposeMain_clicked(){
    graph.setstart(graph.nodes[19]);
    showStart();
}
void MainMap:: on_Pharamacy_clicked(){
    graph.setstart(graph.nodes[20]);
    showStart();
}
void MainMap:: on_R2GO_clicked(){
    graph.setstart(graph.nodes[21]);
    showStart();
}
void MainMap:: on_R__clicked(){
    graph.setstart(graph.nodes[22]);
    showStart();
}
void MainMap:: on_Reception_clicked(){
    graph.setstart(graph.nodes[23]);
    showStart();
}
void MainMap:: on_S__clicked(){
    graph.setstart(graph.nodes[24]);
    showStart();
}
void MainMap:: on_SideS_clicked(){
    graph.setstart(graph.nodes[25]);
    showStart();
}
void MainMap:: on_StaffEntry_clicked(){
    graph.setstart(graph.nodes[26]);
    showStart();
}
void MainMap:: on_Shabrawy_clicked(){
    graph.setstart(graph.nodes[27]);
    showStart();
}
void MainMap:: on_p1_clicked(){
    graph.setstart(graph.nodes[28]);
    showStart();
}
void MainMap:: on_p2_clicked(){
    graph.setstart(graph.nodes[29]);
    showStart();
}
void MainMap:: on_p3_clicked(){
    graph.setstart(graph.nodes[30]);
    showStart();
}
void MainMap:: on_p4_clicked(){
    graph.setstart(graph.nodes[31]);
    showStart();
}
void MainMap:: on_p5_clicked(){
    graph.setstart(graph.nodes[32]);
    showStart();
}
void MainMap:: on_p6_clicked(){
    graph.setstart(graph.nodes[33]);
    showStart();
}
void MainMap:: on_p7_clicked(){
    graph.setstart(graph.nodes[34]);
    showStart();
}
void MainMap:: on_p8_clicked(){
    graph.setstart(graph.nodes[35]);
    showStart();
}
void MainMap:: on_p9_clicked(){
    graph.setstart(graph.nodes[36]);
    showStart();
}
void MainMap:: on_p1_0_clicked(){
    graph.setstart(graph.nodes[37]);
    showStart();
}
void MainMap:: on_p1_1_clicked(){
    graph.setstart(graph.nodes[38]);
    showStart();
}
void MainMap:: on_p1_2_clicked(){
    graph.setstart(graph.nodes[39]);
    showStart();
}
void MainMap:: on_p1_3_clicked(){
    graph.setstart(graph.nodes[40]);
    showStart();
}
void MainMap:: on_p1_4_clicked(){
    graph.setstart(graph.nodes[41]);
    showStart();
}
void MainMap:: on_p1_5_clicked(){
    graph.setstart(graph.nodes[42]);
    showStart();
}
void MainMap:: on_p1_6_clicked(){
    graph.setstart(graph.nodes[43]);
    showStart();
}
void MainMap:: on_p1_7_clicked(){
    graph.setstart(graph.nodes[44]);
    showStart();
}
void MainMap:: on_p1_8_clicked(){
    graph.setstart(graph.nodes[45]);
    showStart();
}
void MainMap:: on_p1_9_clicked(){
    graph.setstart(graph.nodes[46]);
    showStart();
}
void MainMap:: on_p2_0_clicked(){
    graph.setstart(graph.nodes[47]);
    showStart();
}
void MainMap:: on_p2_1_clicked(){
    graph.setstart(graph.nodes[48]);
    showStart();
}
void MainMap:: on_p2_2_clicked(){
    graph.setstart(graph.nodes[49]);
    showStart();
}
void MainMap:: on_p2_3_clicked(){
    graph.setstart(graph.nodes[50]);
    showStart();
}
void MainMap:: on_p2_4_clicked(){
    graph.setstart(graph.nodes[51]);
    showStart();
}
void MainMap:: on_p2_5_clicked(){
    graph.setstart(graph.nodes[52]);
    showStart();
}
void MainMap:: on_p2_6_clicked(){
    graph.setstart(graph.nodes[53]);
    showStart();
}
void MainMap:: on_p2_7_clicked(){
    graph.setstart(graph.nodes[54]);
    showStart();
}
void MainMap:: on_p2_8_clicked(){
    graph.setstart(graph.nodes[55]);
    showStart();
}
void MainMap:: on_p2_9_clicked(){
    graph.setstart(graph.nodes[56]);
    showStart();
}
void MainMap:: on_p3_0_clicked(){
    graph.setstart(graph.nodes[57]);
    showStart();
}
void MainMap:: on_p3_1_clicked(){
    graph.setstart(graph.nodes[58]);
    showStart();
}
void MainMap:: on_p3_2_clicked(){
    graph.setstart(graph.nodes[59]);
    showStart();
}
void MainMap:: on_p3_3_clicked(){
    graph.setstart(graph.nodes[60]);
    showStart();
}
void MainMap:: on_p3_4_clicked(){
    graph.setstart(graph.nodes[61]);
    showStart();
}
void MainMap:: on_p3_5_clicked(){
    graph.setstart(graph.nodes[62]);
    showStart();
}
void MainMap:: on_p3_6_clicked(){
    graph.setstart(graph.nodes[63]);
    showStart();
}
void MainMap:: on_p3_7_clicked(){
    graph.setstart(graph.nodes[64]);
    showStart();
}
void MainMap:: on_p3_8_clicked(){
    graph.setstart(graph.nodes[65]);
    showStart();
}
void MainMap:: on_p3_9_clicked(){
    graph.setstart(graph.nodes[66]);
    showStart();
}
void MainMap:: on_p4_0_clicked(){
    graph.setstart(graph.nodes[67]);
    showStart();
}
void MainMap:: on_p4_1_clicked(){
    graph.setstart(graph.nodes[68]);
    showStart();
}
void MainMap:: on_p4_2_clicked(){
    graph.setstart(graph.nodes[69]);
    showStart();
}
void MainMap:: on_p4_3_clicked(){
    graph.setstart(graph.nodes[70]);
    showStart();
}
void MainMap:: on_p4_4_clicked(){
    graph.setstart(graph.nodes[71]);
    showStart();
}
void MainMap:: on_p4_5_clicked(){
    graph.setstart(graph.nodes[72]);
    showStart();
}
void MainMap:: on_p4_6_clicked(){
    graph.setstart(graph.nodes[73]);
    showStart();
}
void MainMap:: on_p4_7_clicked(){
    graph.setstart(graph.nodes[74]);
    showStart();
}
void MainMap:: on_p4_8_clicked(){
    graph.setstart(graph.nodes[75]);
    showStart();
}
void MainMap:: on_p4_9_clicked(){
    graph.setstart(graph.nodes[76]);
    showStart();
}
void MainMap:: on_p5_0_clicked(){
    graph.setstart(graph.nodes[77]);
    showStart();
}
void MainMap:: on_p5_1_clicked(){
    graph.setstart(graph.nodes[78]);
    showStart();
}
void MainMap:: on_p5_2_clicked(){
    graph.setstart(graph.nodes[81]);
    showStart();
}
void MainMap::showpath(){
    total =0;
    ...
    for(int j=0; j<graph.path.size();j++){
        ...
        if(j<graph.path.size()-1)distance+= graph.path[j]->shortestsl(graph.path[j+1]);
    }
...
void MainMap::on_pushButton_clicked()
{
    reset();
...
void MainMap::display(QString name,QString ID,bool exists)
{
    if(exists)
...
void MainMap::on_out_clicked()
{
    ui->label_4->setText("Area is out of range");
}


void MainMap::on_comboBox_currentIndexChanged(int index)
{
    reset();
