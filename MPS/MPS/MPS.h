...
class MPS : public QMainWindow
{
    ...
    float total = 0;
    QFile* MF = new QFile("resources//MF0.txt");
    QFile* PF = new QFile("resources//PF0.txt");
    QFile* SF = new QFile("resources//SF0.txt");
    QFile* NF = new QFile("resources//NF0.txt");
    QFile* RF = new QFile("resources//RF0.txt");
    QFile* SM = new QFile("resources//SM.txt");
    QFile* OM = new QFile("resources//OM.txt");

public:
    MPS(QWidget* parent = nullptr);
...
private slots:
    ...
    void on_Favs_currentIndexChanged(int index);
private:
    Ui::MPS* ui;
};
